	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		legend style={
	     ...
	     % \xdef\C{5e-8}
	     % \xdef\R{13000}
		\addplot +[mark=*, line width=1.2pt, mark size=1.1pt,  only marks,solid,blue] plot [error bars/.cd, y dir = both, y explicit] table [ x=u, y=tau, ] {../data/ex1.tsv};

		  \addplot [samples=100, line width=1pt, domain=1015:2100, blue!50!black] {780/(1+e^(-0.011*(x-985)))-400+(x-1000)*0.03};
		% \addlegendentry{$U_\text{рез}=150$ В}
